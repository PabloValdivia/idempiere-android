...
//        if (order.getTable() == null && defaultPosData.getDefaultBPartnerToGo() !=  0)
 ...
 //           C_BPartner_ID = defaultPosData.getDefaultBPartner();
     ...
     //   data.addField("C_BPartner_ID", String.valueOf(C_BPartner_ID));
        data.addField("C_BPartner_ID", order.getCBPartner_ID());
    ...
    //    data.addField("C_DocType_ID", IOrder.DocTypeSO); //PosOrder
        data.addField("C_DocTypeTarget_ID", String.valueOf(defaultPosData.getDefaultDocType())); //PosOrder
        data.addField("C_DocType_ID", String.valueOf(defaultPosData.getDefaultDocType())); //PosOrder
