...
public class PosDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_BPARTNER_TABLE =
            "CREATE TABLE " + Tables.TABLE_BPARTNER +
                    "(" +
                    BPartnerContract.BPartnerDB.COLUMN_NAME_BPARTNER_ID + " INTEGER PRIMARY KEY" +
                    ", " +
                    BPartnerContract.BPartnerDB.COLUMN_NAME_NAME + " VARCHAR(64) NOT NULL" +
                    ", " +
                    BPartnerContract.BPartnerDB.COLUMN_NAME_VALUE + " VARCHAR(64) NOT NULL" +
                    ", " +
                    BPartnerContract.BPartnerDB.COLUMN_NAME_PRICE_LIST_ID + " INTEGER NOT NULL" +
                    ", " +
                    BPartnerContract.BPartnerDB.COLUMN_IS_ACTIVE + " INTEGER" +
                    ")";
    ...
    private static final String CREATE_DEFAULT_DATA_TABLE =
            "CREATE TABLE " + Tables.TABLE_DEFAULT_POS_DATA +
                    ...
                    ", " +
                    DefaultPosDataContract.DefaultDataDB.COLUMN_NAME_DOC_TYPE + " INTEGER" +
                    ", " +
