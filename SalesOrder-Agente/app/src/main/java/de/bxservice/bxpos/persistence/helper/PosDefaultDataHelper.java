...
public class PosDefaultDataHelper extends PosObjectHelper {
    ...
    public long createData(DefaultPosData data) {
        ...
        values.put(DefaultPosDataContract.DefaultDataDB.COLUMN_NAME_DOC_TYPE, data.getDefaultDocType());
    ...
    */
    public DefaultPosData getData(long data_id) {
        ...
        defaultData.setDefaultDocType(c.getInt(c.getColumnIndex(DefaultPosDataContract.DefaultDataDB.COLUMN_NAME_DOC_TYPE)));
