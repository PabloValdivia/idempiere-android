...
import de.bxservice.bxpos.logic.webservices.BPartnerWebServicesAdapter;
...
public class DataReader {
    ...
    private List<CBPartner> bpartnerList = new ArrayList<>();
    ...
    public DataReader(final WebServiceRequestData wsData, Context ctx) {
        ...
        Thread BPartnerInfoThread = new Thread(new Runnable() {
            @Override
            public void run() {
                BPartnerWebServicesAdapter bpartnerInfoWS = new BPartnerWebServicesAdapter(wsData);
                if (bpartnerInfoWS.isSuccess()) {
                    bpartnerList = bpartnerInfoWS.getProductList();
                    persistBPartner();
                }
            }
        });
    ...
    private void persistBPartner() {
        for(CBPartner bpartner : bpartnerList)
